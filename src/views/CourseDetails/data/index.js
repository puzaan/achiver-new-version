...
export const Course = [
  {
    ...
    shortDes: [
      'Machine Learning is an Application of Artificial Intelligence. It provides software systems and the devices they run on an ability to collect, process and analyze data that they collect. With application of Machine Learning, devices and systems can learn continuously based on instructions provided by a programmer or autonomously. Eventually, they become able to make accurate predictions devoid of human bias.',
    ],
    link: '/course-detail',
    subtitle: [
    ...
    outcome: [
      {
        ...
        desc:
          'So by the end of the course, youll completely understand: ',
      },
    ],
    feature: [
      {
  ...
  },
  {
    ...
    title: 'IOT',
    shortDes: [
      'All devices that we use, from refrigerators to cars to mobile phone are objects that store and render data. These devices are embedded with sensors, software and processors. They can connect with other devices and can transfer data between each other wirelessly.',
  ...
  },
  {
    ...
    title: 'UI/UX Design',
    shortDes: [
      'Technical products like gadgets, appliances, apps or websites are complex. Human nature is however to look for simplicity and repeated patterns. There is a huge dichotomy between what machines and technological solutions are capable of versus what human users of such machines and products want.',
  ...
  },
  {
    ...
    shortDes: [
      'Knowledge of products and consumers is not enough to sell products in a hyper competitive marketplace which the advent of internet has created. The internet has made starting a business easy. At the same time, every business is always vying for everyone’s attention. ',
      'To be a good and successful marketer, thus, requires knowledge of the consumer and their behaviors. The identification of root biological, psychological, socio-cultural and economic drivers of those behavior is necessary to create and implement a successful marketing strategy over the internet and all forms of digital media. ',
  ...
  },
  {
    ...
    shortDes: [
      'The marketplace is hyper competitive and globalized. Entrepreneurs and enterprises cannot just put out a product in front of the customers and have it sold.',
  ...
  },
  {
    ...
    shortDes: [
      'React and React Native are frameworks developed by Facebook. React is used on Front end of websites whereas react Native is designed for Mobile Applications.',
